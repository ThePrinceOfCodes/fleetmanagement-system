            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <nav class="navbar navbar-expand-xl navbar-light bg-light ">
                         @if($ious_records->count())
                            <div class="nav-brand">
                            
                                <h1 class="tm-site-title mb-4 P-2">{{$ious_records[0]->name}} , {{$ious_records[0]->mobile}}</h1>
                            </div>
                         @endif                       
                        <button class="navbar-toggler ml-auto mr-0" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                            aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <!-- iou indivdual's records -->
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                            <form action="{{route('admin.ious.records.search')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <input type="hidden" value="{{$ious_records[0]->mobile}}" name="mobile" >
                                    </li>
            ...
            <div class="col-md-12 tableview">
              @if($ious_records->count())
                ...
                <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    @foreach($ious_records as $ious_record)
                      <tr>
                        <td>{{$ious_record->description}}</td>
                        <td>{{$ious_record->amount}}</td>
                        <td>{{$ious_record->date}}</td>
                      </tr>
                    @endforeach
                  </tbody>
                  </table>
