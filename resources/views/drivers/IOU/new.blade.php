            ...
            <div class="card card-3">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                     <form action="{{route('admin.iou.input')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                            <div class="row">
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Drivers Name:</label>
                                            <input type="text" class="form-control" name="name" id="formGroupExampleInput" placeholder="eg. Ebuka Eze">
                                        </div>
                                
                                        <div class="form-group">
                                            <label for="formGroupExampleInput2">Drivers Mobile.</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput2" name="mobile" placeholder="eg. 7038505718.">
                                        </div>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Reason for loan</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput" name="description" placeholder="eg. I.O.U for gas">
                                        </div>
                                </div>
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Amount</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput" name="amount" placeholder="amount">
                                        </div>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Date issued</label>
                                            <input type="text" class="form-control" id="formGroupExampleInput" name="date" placeholder="eg. 2021-02-27">
                                        </div>
                                        <div class="form-group">
