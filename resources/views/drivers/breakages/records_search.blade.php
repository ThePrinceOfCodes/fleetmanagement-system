                    ...
                    <nav class="navbar navbar-expand-xl navbar-light bg-light ">
                         @if($breakages_records->count())
                            ...
                            <!-- {{$breakages_records[0]->mobile}} -->
                                <h1 class="tm-site-title mb-4 P-2">{{$breakages_records[0]->name}}</h1>
                            </div>
                         @endif                       
                        <button class="navbar-toggler ml-auto mr-0" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                            aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <!-- adminexpenses -->
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                            <form action="{{route('admin.breakages.records.search')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <ul class="navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item">
                                        <input type="text" name="shipment_no" placeholder="Shipment No.">
                                    </li>

                                    <li class="nav-item">
                                        <input type="text" name="shipment_date" placeholder="Shipment Date.">
                                    </li>
                                    
                                    <li class="nav-item">
                                        <input type="text" name="breakages_cost" placeholder="Total. cost">
                                    </li>

                                    <li class="nav-item">
                                        <input type="hidden" value="{{$breakages_records[0]->mobile}}" name="mobile" >
                                    </li>
