                                ...
                                <ul class="navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="{{ route('admin.trucksexpenses.dashboard')}}">Truck expenses</a>
                                            <a class="dropdown-item"  href="{{ route('admin.adminexpenses.dashboard')}}">Admin expenses</a>
                                            <a class="dropdown-item" href="{{route('admin.ago.dashboard')}}">AGO</a>
                                            <a class="dropdown-item" href="{{route('admin.tripsallowance.dashboard')}}">Trips allowance</a>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="{{route('admin.breakages.dashboard')}}">Brakages</a>
                                            <a class="dropdown-item" href="{{route('admin.iou.dashboard')}}">I.O.U</a>
                                            <a class="dropdown-item" href="{{route('admin.driver.dashboard')}}">Drivers details</a>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.income.dashboard')}}">Income</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="{{route('admin.trucks.dashboard')}}">Trucks Details</a>
                                            <a class="dropdown-item" href="{{route('admin.trucks.events')}}">Trucks Events</a>
                                            <a class="dropdown-item" href="#">Trucks Allocation</a>
                                        </div>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('admin.reports.dashboard')}}">Reports</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="accounts.html">Users</a>
                                    </li>
