            ...
            <div class="card card-3">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                     <form action="{{route('admin.income.add')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput" name="destination" placeholder="Destination" required>
                                    </div>
                                    
                            </div>
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">Frieght cost.</label>
                                        <input type="number" step="0.01" class="form-control" id="formGroupExampleInput2" name="frieght_cost" placeholder="Shipment number." required>
                                    </div>
