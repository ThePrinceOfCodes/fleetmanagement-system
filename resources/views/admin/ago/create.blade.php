            ...
            <div class="card card-3">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                     <form action="{{route('admin.ago.add')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput" name="name" placeholder="eg. Ebuka Eze" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Mobile:</label>
                                        <input type="number" class="form-control" id="formGroupExampleInput" name="mobile" placeholder="7038505718" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Destination</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput" name="destination" placeholder="Description" required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="formGroupExampleInput" name="quantity" placeholder="quantity" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Rate</label>
                                        <input type="number" class="form-control" id="formGroupExampleInput" name="rate" placeholder="rate" required>
                                    </div>
                                    <div class="form-group">
