            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-light badge badge-secondary"  href="{{ route('admin.ago.create')}}">Add AGO</a>    
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <form action="{{route('admin.ago.import')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                    ...
                    <nav class="navbar navbar-expand-xl navbar-light bg-light">
                        <div class="nav-brand">
                            <h1 class="tm-site-title mb-0">AGO.</h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent1">
                            <form action="{{route('admin.ago.search')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <ul class="navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item">
                                        <input type="text" name="name" placeholder="Drivers name">
                                    </li>
                                    <!-- <li class="nav-item">
                  ...
                  <tbody>
                    @foreach($agos as $ago)
                      <tr>
                            ...
                            <td>{{$ago->name}}</td>
                            <td>{{$ago->mobile}}</td>
                            <td>{{$ago->shipment_no}}</td>
                            <td>{{$ago->destination}}</td>
                            <td>{{$ago->quantity}}</td>
                            <td>{{$ago->rate}}</td>
                            <td>{{$ago->total_cost}}</td>
                            <td>{{$ago->date}}</td>
